import foodlogo from '../public/imgs/—Pngtree—food logo_8239825.png'
export const NavBar = () => {
    return (
        <div className="w-full  ">
            <div id="MainContainer" className="flex justify-center">
                <div id="Nav-Container" className="flex justify-between w-1/2 p-5 ">
                    <div id="Logo">
                        <img src={foodlogo} alt="Food-Logo" className="w-16 m-3 hover:scale-110 hover:ease-in-out transition-all"/>
                    </div>
